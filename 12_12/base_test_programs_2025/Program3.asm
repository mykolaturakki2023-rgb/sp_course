...
LABEL@WHILE_00007FF6E96AB078:
    ...
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF6E96AB078
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF6E96AB078
LABEL@AFTER_WHILE_00007FF6E96AB078:
...
LABEL@WHILE_00007FF6E96B39A0:
    ...
    ;after cond expresion (after "while")
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF6E96B39A0
...
LABEL@WHILE_00007FF6E96B73D0:
    ...
    ;after cond expresion (after "while")
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF6E96B73D0
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF6E96B73D0
LABEL@AFTER_WHILE_00007FF6E96B73D0:
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF6E96B39A0
LABEL@AFTER_WHILE_00007FF6E96B39A0:
