...
neg_and_done:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6BFE8D5E0
    ...
    mov eax, 1
LABEL@AFTER_THEN_00007FF6BFE8D5E0:

    ;"else" (part of "elseif")
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6BFE8F2F8
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6BFE920B0
    ...
    mov eax, 1
LABEL@AFTER_ELSE_00007FF6BFE8F2F8:
LABEL@AFTER_THEN_00007FF6BFE920B0:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6BFE93DC8
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF6BFE93DC8:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6BFE9B228
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF6BFE9B228:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6BFE9CB18
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF6BFE9CB18:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6BFEA2260
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF6BFEA2260:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6BFEA3B50
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF6BFEA3B50:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF6BFEA7DD0
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_00007FF6BFEA7DD0:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_00007FF6BFEA96C0
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_00007FF6BFEA96C0:
